...
int main()
{
    // Locally declared structure variables for student information
    struct student s1, s2; // Create two student structures

    // Copying name "Messi" to the first student structure
    ...
    // Copying name "Ronaldo" to the second student structure
